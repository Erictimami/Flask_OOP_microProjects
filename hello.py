...
def hello_world():
    return 'Hello World! It is the first wev serveer of Eric. It is amazing'  # Return the string 'Hello World!' as a response.


@app.route('/success')
def success():
  return "I'm gonna be successful"

@app.route('/hello/<name>') # for a route '/hello/____' anything after '/hello/' gets passed as a variable 'name'
def hello(name):
    print(name)
    return "hello, I'm an expert of software engineering named "+name
